        ...
        <div class="inner-box">
          <div class="forms-wrap">
            ...
            <form action="index.html" autocomplete="off" class="sign-up-form">
              ...
              <input type="button" value="Sign Up" class="sign-btn" onclick="window.location.href='tambah_pelanggan.php';" />
              <input type="button" value="Login Petugas" class="sign-btn" onclick="window.location.href='admin/index.php';" />
                <p class="text">
